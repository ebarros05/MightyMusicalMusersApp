...
public class PlaylistDAO {
    ...
    public static void displayUserPlaylists(Connection conn, String username) {
        String sql = "SELECT p.playlist_name, MAX(p.playlist_number) AS Number_of_Songs, SUM(s.song_length) AS Total_Duration FROM playlist as p INNER JOIN song as s ON p.song_id = s.song_id WHERE p.username = ? GROUP BY p.playlist_name";
